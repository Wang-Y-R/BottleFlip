...
/**
 * BasicRender a point on the current rendering target.
 *
...
/**
 * BasicRender multiple points on the current rendering target.
 *
 * \param renderer the rendering context
...
/**
 * BasicRender a line on the current rendering target.
 *
...
/**
 * BasicRender a series of connected lines on the current rendering target.
 *
 * \param renderer the rendering context
...
/**
 * BasicRender a rectangle on the current rendering target.
 *
 * \param renderer the rendering context
...
/**
 * BasicRender some number of rectangles on the current rendering target.
 *
 * \param renderer the rendering context
...
/**
 * BasicRender a point on the current rendering target at subpixel precision.
 *
...
/**
 * BasicRender multiple points on the current rendering target at subpixel precision.
 *
...
/**
 * BasicRender a line on the current rendering target at subpixel precision.
 *
...
/**
 * BasicRender a series of connected lines on the current rendering target at
 * subpixel precision.
 *
...
/**
 * BasicRender a rectangle on the current rendering target at subpixel precision.
 *
...
/**
 * BasicRender some number of rectangles on the current rendering target at subpixel
 * precision.
 *
